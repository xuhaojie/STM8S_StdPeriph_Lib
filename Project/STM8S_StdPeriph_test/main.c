...
void main(void)
{
  ...
  #elif defined(STM8S208) || defined(STM8AF52Ax)  // muBoard, see http://www.cream-tea.de/presentations/160305_PiAndMore.pdf
...
PUTCHAR_PROTOTYPE
{
  ...
  // non SDCC or SDCC version >=3.6.5
  #if !defined(__SDCC) || (SDCC >= 365)
    return (c);
  #endif
}
